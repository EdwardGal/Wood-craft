...
} else if (searchInput.classList.contains('_active')) {
   searchInput.addEventListener("click", function (e) {
      searchInput.classList.add('_add')
   });
}
...
let sliderTeam = new Swiper('.slider-team__body', {
	/*
	effect: 'fade',
	autoplay: {
		delay: 3000,
	...
	*/
	...
	navigation: {
		nextEl: '.team__slider .slider-arrow_prev',
		prevEl: '.team__slider .slider-arrow_next',
	},
	/*
	breakpoints: {
		320: {
...
let sliderProduction = new Swiper('.slider-production__body', {
	/*
	effect: 'fade',
	autoplay: {
		delay: 3000,
	...
	*/
	...
	navigation: {
		nextEl: '.slider-production .slider-arrow_prev',
		prevEl: '.slider-production .slider-arrow_next',
	},
	/*
	breakpoints: {
		320: {
...
let sliderTabs = new Swiper('.slider-tabs__body', {
	/*
	effect: 'fade',
	autoplay: {
		delay: 3000,
	...
	*/
	...
	navigation: {
		nextEl: '.slider-tabs .slider-arrow_prev',
		prevEl: '.slider-tabs .slider-arrow_next',
	},
	/*
	breakpoints: {
		320: {
